...
class GeneralizedFullSparseRBMNode : RBMNodeBase {
private:
	size_t vSize = 0;
	size_t hSize = 0;
public:
...
public:
	GeneralizedFullSparseRBMNode() = default;
	GeneralizedFullSparseRBMNode(size_t v_size, size_t h_size);
	~GeneralizedFullSparseRBMNode() = default;
...
// 可視変数に値をセット
template<typename ARRAY>
void GeneralizedFullSparseRBMNode::setVisibleData(ARRAY & data) {
