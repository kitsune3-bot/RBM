...
class GeneralizedFullSparseRBMParamator : RBMParamatorBase {
private:
	size_t vSize;
	size_t hSize;
public:
	...
	Eigen::VectorXd sparseC;  // 隠れ変数のスパースパラメータ
	Eigen::MatrixXd sparseW;


public:
	GeneralizedFullSparseRBMParamator() = default;
	GeneralizedFullSparseRBMParamator(size_t vsize, size_t hsize);
	~GeneralizedFullSparseRBMParamator() = default;
