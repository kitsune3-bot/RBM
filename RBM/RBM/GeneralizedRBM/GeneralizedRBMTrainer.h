...
void Trainer<GeneralizedRBM>::initMomentum(GeneralizedRBM & rbm) {
...
void Trainer<GeneralizedRBM>::initMomentum() {
...
void Trainer<GeneralizedRBM>::updateMomentum(GeneralizedRBM & rbm) {
	for (int i = 0; i < rbm.getVisibleSize(); i++) {
